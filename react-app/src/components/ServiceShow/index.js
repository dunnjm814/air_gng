  ...
  return <>
    {service && <div>
      <div className="service_main_container">
        ...
        <div>
          <img className='service_main_image' src={service.biz_image} alt="aircraft" />
        </div>
        <div className="service_main_description">
          <div>
            <span>Supercrafts</span>
            <p>Supercrafts are experienced, highly rated hosts who are committed to providing great stays for guests.</p>
            <span>Entire Aircraft</span>
            <p>You'll have the aircraft all to yourself.</p>
            <span>Enhanced clean</span>
            <p>This business is commited to Airgng's 5-step cleaning process.</p>
